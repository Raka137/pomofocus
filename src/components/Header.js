...
function Header({  onSettingsClick, onReportClick }) {
  return (
    <header className="app-header">
      <nav className="header-nav">
        <div className="header-logo">
          {/* SVG untuk ikon checkmark */}
        ...
        <div className="header-actions">
         <button className="header-btn" onClick={onReportClick}>
            {/* SVG untuk ikon report/grafik */}
